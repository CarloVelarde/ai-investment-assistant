...
- [x] **Later milestone (market history / episode rules):** Decided in Milestone 3 / D-021 — open episodes only; close when all detector keys for ticker+direction rearm/clear after daily evaluation. See `specs/003-market-history-and-offline-detection/`.
