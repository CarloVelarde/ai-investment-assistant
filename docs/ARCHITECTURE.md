...
- [Regular session lifecycle correction](../specs/007-regular-session-lifecycle/SPEC.md) is the approved pre-Milestone-5 correction: isolate regular minutes, gate the socket by session state, close the startup history/stream handoff, and recover the latest missed daily scan.
