...
- [Research and reporting](../specs/009-research-and-reporting/SPEC.md) is in implementation: live mode now runs one bounded research attempt per pass, recovers regular-minute gaps afterward, and prints a cited console report. Discord remains Milestone 7.
