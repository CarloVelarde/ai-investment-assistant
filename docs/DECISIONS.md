...
and recovery commands belong to spec 010. Milestone 7's deterministic acceptance
checks passed; full-loop live-provider verification belongs to Milestone 8.
